...
console.log('1');
    $.util = {
        ...
        to_user_currencyF: (amount) => {
            return `${$.util.to_user_currency(amount)} ${$.util.user_currency()}`;
        },

        min_balance: () => {
            return $.util.to_user_currency(config.defaults.min_balance[$.user.currency]);
        },

        min_balanceF: () => {
            return `${$.util.min_balance()} ${$.util.user_currency()}`;
        },
        ...
        rateF: (rate) => {
            return `${$.util.parseRate(rate)} ${$.util.usd_currency()}`;
        },
...
console.log($);
        ...
        rub_to_user_currencyF: (amount) => {
            return `${$.util.rub_to_user_currency(amount)} ${$.util.user_currency()}`;
        }
    };
